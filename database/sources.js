import { ageFormatter, chromosomeFormatter, invalidNumberFormatter, patternExtractionFormatter, unparsedColonNumericValueFormatter } from './services/formatters.js';
...
export const sources = [
  {
    ...
    columns: [
      ...
      { sourceName: "MCF_v12.3_score", name: "MCF_v12_3_score", formatter: invalidNumberFormatter },
      { sourceName: "MCF_v12.5", name: "MCF_v12_5" },
      { sourceName: "MCF_v12.5_score", name: "MCF_v12_5_score", formatter: invalidNumberFormatter },
